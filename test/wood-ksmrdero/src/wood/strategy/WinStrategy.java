...
public class WinStrategy implements WoodPlayerStrategy {
     ...
     */
    TurnAction considerOpponentAction(PlayerBoardView boardView) {
     ...
     */
    TurnAction moveToPoint(Point newPoint) {
